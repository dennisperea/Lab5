...
public class dvrouter{
  ...
  */
  ...
  public static void main(String [] args){
    ...
    dvrouter dvrout = new dvrouter();
    dvrout.createTopologyFile(args, graph);
    dvrout.createConnections(args, graph);
    graph.printRoutingTable();
    dvrout.readMessageFiles(args, graph);
    dvrout.readChangesFile(args, graph);
  }
}
